KManager.action :bootstrap do
  action do
    application_name = :test_google_cloud_functions
    director = KDirector::Dsls::RubyGemDsl
      ...
      .data(
        ...
        application_description:    'Sample GEM using the functions_framework GEM so that we can build google cloud functions',
        application_lib_path:       application_name.to_s,
        application_lib_namespace:  'TestGoogleCloudFunctions',
        namespaces:                 ['TestGoogleCloudFunctions'],
        author:                     'David Cruwys',
        author_email:               'david@ideasmen.com.au',
        initial_semver:             '0.0.1',
        main_story:                 '',
        copyright_date:             '2022',
        website:                    'http://appydave.com/gems/test_google_cloud_functions'
      )
      .github(
        active: true,
        repo_name: application_name,
        organization: 'klueless-gem-samples'
      ) do
        create_repository
        # delete_repository
        # list_repositories
...
KManager.opts.app_name                    = 'test_google_cloud_functions'
